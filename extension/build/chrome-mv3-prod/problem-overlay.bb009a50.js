var e,t;"function"==typeof(e=globalThis.define)&&(t=e,e=null),function(t,o,n,r,a){var l="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i="function"==typeof l[r]&&l[r],s=i.cache||{},d="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function c(e,o){if(!s[e]){if(!t[e]){var n="function"==typeof l[r]&&l[r];if(!o&&n)return n(e,!0);if(i)return i(e,!0);if(d&&"string"==typeof e)return d(e);var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}u.resolve=function(o){var n=t[e][1][o];return null!=n?n:o},u.cache={};var p=s[e]=new c.Module(e);t[e][0].call(p.exports,u,p,p.exports,this)}return s[e].exports;function u(e){var t=u.resolve(e);return!1===t?{}:c(t)}}c.isParcelRequire=!0,c.Module=function(e){this.id=e,this.bundle=c,this.exports={}},c.modules=t,c.cache=s,c.parent=i,c.register=function(e,o){t[e]=[function(e,t){t.exports=o},{}]},Object.defineProperty(c,"root",{get:function(){return l[r]}}),l[r]=c;for(var p=0;p<o.length;p++)c(o[p]);if(n){var u=c(n);"object"==typeof exports&&"undefined"!=typeof module?module.exports=u:"function"==typeof e&&e.amd?e(function(){return u}):a&&(this[a]=u)}}({"2ZIMm":[function(e,t,o){var n=e("@parcel/transformer-js/src/esmodule-helpers.js");n.defineInteropFlag(o),n.export(o,"config",()=>l);var r=e("../lib/leetcode-url"),a=e("./ZenithSystemOverlay");let l={matches:["https://leetcode.com/problems/*","https://leetcode.com/contest/*/problems/*"],run_at:"document_idle"},i=!1,s=!1,d=()=>{if(!i||s)return;let e=document.querySelectorAll('[role="tablist"] > *, [role="tablist"] [role="tab"], [role="tablist"] a, [role="tablist"] button');e.forEach(e=>{if(e.id?.includes("av-")||e.closest("plasmo-csui"))return;let t=e.textContent?.trim()||"";(t.includes("Editorial")||t.includes("Solutions")||t.includes("Discussion")||t.includes("Discuss"))&&e.style.setProperty("display","none","important")})},c=()=>{if(!i||s)return;let e=document.querySelector('[role="tablist"]');if(e&&!document.getElementById("av-intentional-reveal")){let t=document.createElement("button");t.id="av-intentional-reveal",t.className="ml-auto text-xs px-3 py-1 rounded bg-red-500/10 text-red-400 border border-red-500/20 hover:bg-red-500/20 transition-colors font-medium flex items-center gap-1 cursor-pointer font-mono select-none",t.innerHTML="<span>\uD83D\uDD12</span> Yield & Reveal Solutions",t.title="Hold for 2 seconds to yield and reveal solutions";let o=null;t.onmousedown=()=>{t.innerHTML="<span>\uD83D\uDD13</span> Yielding...",t.style.backgroundColor="rgba(239, 68, 68, 0.3)",o=window.setTimeout(()=>{chrome.storage.local.set({"algovault.zenithGrade":"D","algovault.zenithReason":"Intentional Reveal"},()=>{s=!0,document.querySelectorAll('[role="tab"], a, button, div').forEach(e=>{let t=e.textContent?.trim()||"";if("Editorial"===t||"Solutions"===t||"Discussion"===t){e.style.removeProperty("display");let t=e.closest('[role="tab"]');t&&t.style.removeProperty("display")}}),t.innerHTML="<span>\u2705</span> Solutions Revealed",t.disabled=!0,t.style.opacity="0.5",t.style.cursor="default"})},2e3)},t.onmouseup=t.onmouseleave=()=>{o&&(clearTimeout(o),t.disabled||(t.innerHTML="<span>\uD83D\uDD12</span> Yield & Reveal Solutions",t.style.backgroundColor="rgba(239, 68, 68, 0.1)"))},e.appendChild(t)}},p=e=>{let t=document.getElementById("av-zenith-style");if(e)t||((t=document.createElement("style")).id="av-zenith-style",t.textContent=`
      ...
      `,document.head.appendChild(t)),d(),c();else{s=!1,t&&t.remove();let e=document.getElementById("av-intentional-reveal");e&&e.remove(),document.querySelectorAll('[role="tab"], a, button').forEach(e=>{"none"===e.style.display&&e.style.removeProperty("display")})}};chrome.storage.local.get("algovault.isZenith",e=>{p(i=!!e["algovault.isZenith"])}),chrome.storage.onChanged.addListener((e,t)=>{"local"===t&&e["algovault.isZenith"]&&p(i=!!e["algovault.isZenith"].newValue)});let u=!1,m=!1,f=!1,g=null,b=new Map,x=new Set,y=async()=>{let e=(0,r.getLeetCodeProblemSlug)();if(e)for(let t=0;t<3;t+=1){try{let t=await new Promise(t=>{chrome.runtime.sendMessage({action:"get_prediction",slug:e},t)});if(!t?.error){g=t,h();return}}catch(e){console.error("AlgoVault Prediction Error:",e)}await new Promise(e=>setTimeout(e,1e3))}},h=()=>{m||chrome.storage.sync.get(["hideAcceptanceRate"],e=>{if(!1===e.hideAcceptanceRate)return;let t=document.querySelector('[data-track-load="description_content"]')?.parentElement||document.querySelector('[role="tabpanel"]');if(!t)return;let o=document.evaluate(".//*[text()='Acceptance' or text()='Acceptance Rate']",t,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null),n=o.singleNodeValue;if(n){let e=n.nextElementSibling;if(e&&e.textContent?.includes("%")||(e=n.parentElement?.nextElementSibling),e&&"none"!==e.style.display&&e.textContent?.includes("%")){let t=e.textContent||"";e.style.display="none";let o=document.createElement("div");o.className="text-label-1 dark:text-dark-label-1 font-medium flex items-center gap-2";let r=document.createElement("span");r.textContent="Hidden";let a=document.createElement("button");a.textContent="\uD83D\uDC41 Show",a.style.cursor="pointer",a.style.color="#00d4aa",a.style.fontSize="12px";let l=!1;a.onclick=()=>{l=!l,r.textContent=l?t:"Hidden",a.textContent=l?"\uD83D\uDC41 Hide":"\uD83D\uDC41 Show"},o.appendChild(r),o.appendChild(a),n.parentElement?.appendChild(o),m=!0}}});let{diffTag:e,metadataRow:t}=(()=>{let e=document.querySelector("[data-algovault-rating]");if(e&&e.parentElement){let t=Array.from(e.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE||!e.classList?.contains("av-rating")).map(e=>e.textContent||"").join("").trim();if("Easy"===t||"Medium"===t||"Hard"===t)return{diffTag:e,metadataRow:e.parentElement};e.removeAttribute("data-algovault-rating"),e.querySelectorAll(".av-rating").forEach(e=>e.remove())}document.querySelectorAll(".av-rating").forEach(e=>{let t=e.parentElement?.textContent?.replace(/\s*\(\d+\)\s*$/,"").trim()||"";"Easy"!==t&&"Medium"!==t&&"Hard"!==t&&e.remove()});let t=[document.querySelector('[data-track-load="description_content"]')?.parentElement,document.querySelector('[role="tabpanel"]'),document.querySelector('div[class*="description"]')].filter(Boolean);for(let e of t){let t=Array.from(e.querySelectorAll('[class*="text-difficulty-"], [class*="text-olive"], [class*="text-yellow"], [class*="text-pink"], [class*="text-green"], [class*="text-red"], [class*="text-brand-orange"], div[class*="rounded-full"], span[class*="rounded-full"], div[class*="badge"], span[class*="badge"]'));for(let e of t){if(e.querySelector('button, [role="button"], a, input, #av-company-trigger-btn, #av-start-zenith-btn'))continue;let t=Array.from(e.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE||!e.classList?.contains("av-rating")).map(e=>e.textContent||"").join("").trim();if("Easy"===t||"Medium"===t||"Hard"===t)return{diffTag:e,metadataRow:e.parentElement}}}let o=Array.from(document.querySelectorAll('button, [role="button"]')).find(e=>{let t=e.textContent?.trim()||"";return"Topics"===t||"Companies"===t||t.startsWith("Topics")||t.startsWith("Companies")});if(o&&o.parentElement){let e=o.parentElement;for(let t of Array.from(e.children)){let o=Array.from(t.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE||!e.classList?.contains("av-rating")).map(e=>e.textContent||"").join("").trim();if("Easy"===o||"Medium"===o||"Hard"===o)return{diffTag:t,metadataRow:e}}return{diffTag:null,metadataRow:e}}return{diffTag:null,metadataRow:null}})(),o=(0,r.getLeetCodeProblemSlug)(),n=e?.getAttribute("data-algovault-rating");if(e&&o&&n!==o){e.setAttribute("data-algovault-rating",o),e.querySelector(".av-rating")?.remove();let t=t=>{if((0,r.getLeetCodeProblemSlug)()!==o||!Number.isFinite(t))return;let n=Math.round(Number(t)),a=e.querySelector(".av-rating");a&&a.remove();let l=document.createElement("span");l.className="av-rating ml-2 font-mono font-bold opacity-90",l.dataset.algovaultRating=o,l.textContent=` (${n})`,l.title="ZeroTrac contest rating",e.appendChild(l),u=!0};chrome.runtime.sendMessage({action:"get_problem_rating",slug:o},e=>{e&&"number"==typeof e.Rating&&t(e.Rating)})}let l=t||e?.parentElement;if(o&&l){let e=document.getElementById("av-company-trigger-btn"),t=e?.getAttribute("data-slug");if(!e||t!==o){e?.remove();let t=o.toLowerCase();if(!b.has(t)){!function(e){let t=e.toLowerCase();b.has(t)||x.has(t)||(x.add(t),chrome.runtime.sendMessage({action:"get_companies_for_problem",slug:t},e=>{x.delete(t),chrome.runtime.lastError||(b.set(t,Array.isArray(e?.evidences)?e.evidences:[]),r.getLeetCodeProblemSlug()?.toLowerCase()===t&&h())}))}(o);return}let n=b.get(t)||[];if(n.length>0){let e=l.parentElement||l,t=Array.from(e.querySelectorAll('button, div[role="button"], a')).find(e=>{if("av-company-trigger-btn"===e.id||e.closest("#av-company-trigger-btn"))return!1;let t=e.textContent?.trim()||"";return"Companies"===t||t.startsWith("Companies")||t.endsWith("Companies")});t||(t=Array.from(e.querySelectorAll("div, span, button, a")).find(e=>{if("av-company-trigger-btn"===e.id||e.closest("#av-company-trigger-btn"))return!1;let t=e.textContent?.trim()||"";return"Companies"===t||t.startsWith("Companies")})),t||(t=Array.from(document.querySelectorAll('button, div[role="button"]')).find(e=>{if("av-company-trigger-btn"===e.id||e.closest("#av-company-trigger-btn"))return!1;let t=e.textContent?.trim()||"";return"Companies"===t||t.startsWith("Companies")}));let r=document.createElement("button");r.id="av-company-trigger-btn",r.setAttribute("data-slug",o),r.className="flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full cursor-pointer transition-colors",r.title=`Asked by ${n.length} companies in interviews (Click to explore)`,r.innerHTML=`
